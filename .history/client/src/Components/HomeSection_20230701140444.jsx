...
const HomeSection = () => {
   return (
    ...
    Image by <a href="https://www.freepik.com/free-photo/overhead-view-coffee-cup-keyboard-camera-paper-white-background_3787339.htm#query=blog%20website%20bg&position=49&from_view=search&track=ais">Freepik</a>
    </div>
   )
}
