          ...
          <div className="articles">
            ...
            <div className='article-area'> 
              <div className='article-icons'>
                ...
                <button onClick={blockEvent}><AiOutlineBlock /></button>
                <button onClick={italicEvent}><AiOutlineItalic /></button>
                <button onClick={boldEvent}><AiOutlineBold/></button>
                <button onClick={listEvent}><AiOutlineUnorderedList /></button>
