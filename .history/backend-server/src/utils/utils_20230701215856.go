...
func ParseArticle(r *http.Request, blog interface{}) {
	...
	postData := fmt.Sprintf(`{"Title": "%s", "Description": "%s", "Content": "%s", "Author": "%s", "Featured": "%s", "Created": "%s"}`, matter.Title, matter.Description, contentString, matter.Author, matter.Featured, postTime)
