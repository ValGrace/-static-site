...
func ParseArticle(r *http.Request, blog interface{}) {
	...
	postData := fmt.Sprintf(`{"ID": "%v", "Title": "%s", "Content": "%s", "Author": "%s", "Featured": "%s", "Created": "%s"}`, rand.Int63(), matter.Title, contentString, matter.Author, matter.Featured, postTime)
